...
type Metricer interface {
	...
	RecordCrossUnsafeRef(chainID eth.ChainID, r eth.L2BlockRef)
	RecordCrossSafeRef(chainID eth.ChainID, r eth.L2BlockRef)
...
func (m *Metrics) RecordCrossUnsafeRef(chainID eth.ChainID, ref eth.L2BlockRef) {
	m.RefMetrics.RecordRef("l2", "cross_unsafe", ref.Number, ref.Time, ref.Hash, chainIDLabel(chainID))
}

func (m *Metrics) RecordCrossSafeRef(chainID eth.ChainID, ref eth.L2BlockRef) {
